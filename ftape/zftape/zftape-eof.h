 ...
 * adaptaed for zftape 1996-1998 by Claus Heine
...
extern void zft_ftape_extract_file_marks(struct zftape_info *zftape,
					 __u8* address);
extern int  zft_ftape_validate_label(struct zftape_info *zftape, char* label);
extern void zft_clear_ftape_file_marks(struct zftape_info *zftape);
