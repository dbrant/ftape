 ...
 */
extern void ftape_extract_bad_sector_map(struct ftape_info *ftape,
					 __u8 * buffer);
extern SectorMap ftape_get_bad_sector_entry(struct ftape_info *ftape,
					    int segment_id);
extern void      ftape_put_bad_sector_entry(struct ftape_info *ftape,
					    int segment_id, SectorMap mask);
extern __u8 *ftape_find_end_of_bsm_list(__u8 * address);
extern void ftape_init_bsm(struct ftape_info *ftape);
