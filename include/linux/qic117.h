...
/*48*/ {"undefined",                 0x00, 0x00, unused, 0, discretional},\
/*49*/ {"undefined",                 0x00, 0x00, unused, 0, discretional},\
/*50*/ {"extended select rate",      0x03, 0x01, mode,   0, required},\
/*51*/ {"ext report drive config",   0x00, 0x00, report, 0, required},\
/*52*/ {"load/unload",               0x03, 0x01, unused, 0, discretional},\
/*53*/ {"toggle lock",               0x07, 0x05, unused, 0, discretional},\
/*54*/ {"partition status",          0x02, 0x00, unused, 0, discretional},\
/*55*/ {"seek to partition",         0x07, 0x05, unused, 0, discretional},\
}
...
/*
 *      Status bits returned by QIC_EXT_REPORT_DRIVE_CONFIGURATION
 */

#define QIC_EXT_CONFIG_RATE_MASK 0x07
#define QIC_EXT_CONFIG_RATE_1000 0x01
#define QIC_EXT_CONFIG_RATE_2000 0x02
#define QIC_EXT_CONFIG_RATE_3000 0x03
#define QIC_EXT_CONFIG_RATE_4000 0x04

/*
 *      Status bits returned by QIC_LOADER_PARTITION_STATUS
 *
 * Yet missing: the meaning of 0x40, 0x04. Don't know whether
 *              0x02 is used at all.
 */
#define QIC_LOADER_PART_MASK  0x03
#define QIC_LOADER_PART_ZERO  0x00
#define QIC_LOADER_PART_ONE   0x01
#define QIC_LOADER_PART_TWO   0x02 /* unused, I think */
#define QIC_LOADER_PERT_THREE 0x03 /* unused, I think */
#define QIC_LOADER_WHAT_THE_HELL_IS_THIS 0x04
#define QIC_LOADER_DOOR_OPEN  0x10
#define QIC_LOADER_LOCKED     0x20
#define QIC_LOADER_WHAT_THE_HELL_IS_THIS_EITHER 0x40
