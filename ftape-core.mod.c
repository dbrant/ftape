...
SYMBOL_CRC(ftape_get_bad_sector_entry, 0x00f4c799, "_gpl");
SYMBOL_CRC(ftape_find_end_of_bsm_list, 0x46738687, "_gpl");
SYMBOL_CRC(ftape_set_state, 0x05a6f11d, "_gpl");
SYMBOL_CRC(ftape_seek_to_bot, 0xae6f89d0, "_gpl");
SYMBOL_CRC(ftape_seek_to_eot, 0xbbac09b3, "_gpl");
SYMBOL_CRC(ftape_abort_operation, 0x44276b71, "_gpl");
SYMBOL_CRC(ftape_get_status, 0x28a64408, "_gpl");
SYMBOL_CRC(ftape_enable, 0x7ec0d5d4, "_gpl");
SYMBOL_CRC(ftape_disable, 0x5eafa581, "_gpl");
SYMBOL_CRC(ftape_destroy, 0xdd0e4abf, "_gpl");
SYMBOL_CRC(ftape_calibrate_data_rate, 0x22771ca6, "_gpl");
SYMBOL_CRC(ftape_get_drive_status, 0x0a934ac1, "_gpl");
SYMBOL_CRC(ftape_reset_drive, 0x9c73d8f4, "_gpl");
SYMBOL_CRC(ftape_command, 0x9926d23b, "_gpl");
SYMBOL_CRC(ftape_parameter, 0x9fe25cfc, "_gpl");
SYMBOL_CRC(ftape_ready_wait, 0xf82c048d, "_gpl");
SYMBOL_CRC(ftape_report_operation, 0x747f8bc3, "_gpl");
SYMBOL_CRC(ftape_report_error, 0xa687a0a8, "_gpl");
SYMBOL_CRC(ftape_door_lock, 0x56dae88a, "_gpl");
SYMBOL_CRC(ftape_door_open, 0x505040ec, "_gpl");
SYMBOL_CRC(ftape_set_partition, 0xd84200f0, "_gpl");
SYMBOL_CRC(ftape_ecc_correct, 0x5577ef93, "_gpl");
SYMBOL_CRC(ftape_read_segment, 0x33895a77, "_gpl");
SYMBOL_CRC(ftape_zap_read_buffers, 0x0453bb8c, "_gpl");
SYMBOL_CRC(ftape_read_header_segment, 0xbbc933b6, "_gpl");
SYMBOL_CRC(ftape_decode_header_segment, 0x781bcaef, "_gpl");
SYMBOL_CRC(ftape_write_segment, 0xf1beb34d, "_gpl");
SYMBOL_CRC(ftape_loop_until_writes_done, 0x5d049c50, "_gpl");
SYMBOL_CRC(ftape_hard_error_recovery, 0xd8b907ad, "_gpl");
SYMBOL_CRC(fdc_infos, 0x5de4d578, "_gpl");
SYMBOL_CRC(fdc_register, 0x7213e04b, "_gpl");
SYMBOL_CRC(fdc_unregister, 0xc9671fca, "_gpl");
SYMBOL_CRC(fdc_disable_irq, 0x64167c63, "_gpl");
SYMBOL_CRC(fdc_enable_irq, 0x5ae50fbe, "_gpl");
...
SYMBOL_CRC(fdc_set_nr_buffers, 0x4ba193b3, "_gpl");
SYMBOL_CRC(fdc_get_deblock_buffer, 0x3e8120ca, "_gpl");
SYMBOL_CRC(fdc_put_deblock_buffer, 0xc34ea2d1, "_gpl");
SYMBOL_CRC(ftape_format_track, 0xdbb61f6c, "_gpl");
SYMBOL_CRC(ftape_format_status, 0xbd708c13, "_gpl");
SYMBOL_CRC(ftape_verify_segment, 0x8f89119a, "_gpl");
...
MODULE_INFO(srcversion, "C2BA68DE198D07C60C89646");
