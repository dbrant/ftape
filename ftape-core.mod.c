...
SYMBOL_CRC(ftape_get_bad_sector_entry, 0x08f30b44, "_gpl");
SYMBOL_CRC(ftape_find_end_of_bsm_list, 0x46738687, "_gpl");
SYMBOL_CRC(ftape_set_state, 0x40a910c7, "_gpl");
SYMBOL_CRC(ftape_seek_to_bot, 0xb25cfa94, "_gpl");
SYMBOL_CRC(ftape_seek_to_eot, 0xf1393f96, "_gpl");
SYMBOL_CRC(ftape_abort_operation, 0x42bd0fd9, "_gpl");
SYMBOL_CRC(ftape_get_status, 0xbfc53358, "_gpl");
SYMBOL_CRC(ftape_enable, 0x7ec0d5d4, "_gpl");
SYMBOL_CRC(ftape_disable, 0x5eafa581, "_gpl");
SYMBOL_CRC(ftape_destroy, 0xdd0e4abf, "_gpl");
SYMBOL_CRC(ftape_calibrate_data_rate, 0x4d3ce2d3, "_gpl");
SYMBOL_CRC(ftape_get_drive_status, 0xef0e0c90, "_gpl");
SYMBOL_CRC(ftape_reset_drive, 0xaad1ab67, "_gpl");
SYMBOL_CRC(ftape_command, 0x2a19a65e, "_gpl");
SYMBOL_CRC(ftape_parameter, 0x886b2f66, "_gpl");
SYMBOL_CRC(ftape_ready_wait, 0x35eca810, "_gpl");
SYMBOL_CRC(ftape_report_operation, 0xde08b54d, "_gpl");
SYMBOL_CRC(ftape_report_error, 0xf31efea5, "_gpl");
SYMBOL_CRC(ftape_door_lock, 0xadf3266f, "_gpl");
SYMBOL_CRC(ftape_door_open, 0x5a7015a8, "_gpl");
SYMBOL_CRC(ftape_set_partition, 0x4203e354, "_gpl");
SYMBOL_CRC(ftape_ecc_correct, 0x7ed47300, "_gpl");
SYMBOL_CRC(ftape_read_segment, 0x5bd07dd2, "_gpl");
SYMBOL_CRC(ftape_zap_read_buffers, 0xf5e03582, "_gpl");
SYMBOL_CRC(ftape_read_header_segment, 0xf153e2e3, "_gpl");
SYMBOL_CRC(ftape_decode_header_segment, 0x2f549456, "_gpl");
SYMBOL_CRC(ftape_write_segment, 0x41f7480b, "_gpl");
SYMBOL_CRC(ftape_loop_until_writes_done, 0x18cb6b22, "_gpl");
SYMBOL_CRC(ftape_hard_error_recovery, 0xcf212109, "_gpl");
SYMBOL_CRC(fdc_infos, 0xb8643314, "_gpl");
SYMBOL_CRC(fdc_register, 0x21f14a34, "_gpl");
SYMBOL_CRC(fdc_unregister, 0x24588a33, "_gpl");
SYMBOL_CRC(fdc_disable_irq, 0x0f98820c, "_gpl");
SYMBOL_CRC(fdc_enable_irq, 0x2d8c9f1d, "_gpl");
...
SYMBOL_CRC(fdc_set_nr_buffers, 0x64eab2d9, "_gpl");
SYMBOL_CRC(fdc_get_deblock_buffer, 0x2057fc2a, "_gpl");
SYMBOL_CRC(fdc_put_deblock_buffer, 0xe34dcdda, "_gpl");
SYMBOL_CRC(ftape_format_track, 0x26d0fdc2, "_gpl");
SYMBOL_CRC(ftape_format_status, 0x642b94d7, "_gpl");
SYMBOL_CRC(ftape_verify_segment, 0xc9507ec0, "_gpl");
...
MODULE_INFO(srcversion, "9089A87B3BA90C3A2FDD046");
